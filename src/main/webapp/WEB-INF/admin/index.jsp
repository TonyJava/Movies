...
<%@page import="com.movies.entity.Admin"%>
<%@page import="com.movies.service.AdminService"%>
<%@page import="com.movies.util.SpringUtils"%>
<%@page import="com.movies.util.WebUtils"%>
<%
